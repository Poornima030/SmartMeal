...
export const CookingMode: React.FC<Props> = ({ recipe, onClose }) => {
  ...
  return (
    ...
    >
      {/* Header */}
      <div className="px-4 md:px-8 py-4 md:py-6 flex items-center justify-between border-b border-stone-100 dark:border-stone-800">
      ...
      {/* Main Content Area - Centered and Non-scrollable */}
      <div className="flex-1 flex flex-col items-center justify-center px-6 md:px-8 text-center max-w-5xl mx-auto w-full overflow-hidden">
        <AnimatePresence mode="wait">
          ...
          >
            <div className="inline-flex items-center justify-center w-10 h-10 md:w-14 md:h-14 rounded-full bg-brand-100 dark:bg-brand-900/30 text-brand-600 dark:text-brand-400 font-bold text-lg md:text-2xl">
              {currentStep + 1}
            </div>
            
            <h3 className="text-2xl md:text-5xl lg:text-6xl font-serif font-bold leading-tight text-stone-900 dark:text-white px-2">
              {step.text}
            </h3>
            ...
            {step.timer && (
              <div className="pt-4 flex flex-col items-center gap-4">
                {timeLeft === null ? (
                  ...
                  <div className="w-full max-w-md p-6 md:p-8 rounded-[2rem] bg-stone-50 dark:bg-stone-900/50 border border-stone-100 dark:border-stone-800 space-y-4">
                    <div className={cn(
      ...
      <div className="px-6 md:px-8 py-6 md:py-8 bg-white dark:bg-stone-950 border-t border-stone-100 dark:border-stone-800">
        <div className="max-w-3xl mx-auto space-y-6">
          ...
          <div className="flex gap-3 md:gap-6">
            <button
              ...
              className="flex-1 py-4 md:py-5 rounded-2xl md:rounded-3xl bg-stone-100 dark:bg-stone-900 font-bold text-stone-800 dark:text-stone-300 disabled:opacity-30 flex items-center justify-center gap-2 hover:bg-stone-200 dark:hover:bg-stone-800 transition-all"
            >
            ...
            <button
              ...
              className="flex-[2] py-4 md:py-5 rounded-2xl md:rounded-3xl bg-brand-600 dark:bg-brand-500 text-white font-bold shadow-xl shadow-brand-600/30 dark:shadow-brand-500/30 flex items-center justify-center gap-2 hover:bg-brand-700 dark:hover:bg-brand-600 transition-all"
            >
